...
xlabel('Frequency (DFT index)','Fontsize',15)
title('(A) Fourier coefficients (DFT)');
%legend('(A) Fourier coefficients (DFT)','Fontsize',10);
box off
printme('DFT')
...
%legend('(B) Fourier coefficients (least square solution)','Fontsize',10);
xlabel('Frequency (index)','Fontsize',15)
box off
xlim([0 N])
